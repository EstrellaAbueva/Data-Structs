...
class LinkedList : public List {
    ...
    public:
        ...
        //START HERE
        char removeAt(int pos) {
            char elem = -1;// also if the value greater/less than; return value
